      ...
      <div className={styles.content}>
        ...
        <div className={styles.body}>
          <p>
            ...
            ямы, шуршание, пропажа моркови, датчик движения. Система по ним оценивает{" "}
          ...
          <ul>
            ...
            <li>
              <strong>«Запустить» / «Пауза».</strong> Блок «Симулятор фермы» слева вверху. Включает и
            ...
            <li>
              <strong>Ползунки «Параметры сигналов».</strong> Там же ниже. k, τ и пороги
            ...
            <li>
              <strong>«AI Worklog».</strong> Кнопка внизу страницы. Пошаговый лог разработки
              фермы: от брейншторма до продакшена. В первом шаге ссылка на доску Excalidraw с
              ходом мысли и перепиской с моделями.
            </li>
          </ul>
