...
const WORKLOG_STEPS = [
  {
    title: "Осознаю задачу",
    body:
      "Сначала складываю задание на борд, раскладываю его на составляющие, формулирую к нему вопросы, отвечаю на них, пишу гипотезы и идеи. На борде интереснее всего отследить ход моей мысли! Также это и есть лог всего этапа проектирования и часть переписки с моделями https://excalidraw.com/#room=f72b1750d94fa24faab5,HAWB40wlGegwaCnJFi1Ogw",
  },
  {
    title: "Формулирую гипотезу на основе своих вопросов на борде",
    body:
      "Собираю связную версию того, как задача может решаться и выглядеть. Она нужна мне как вектор, ведь в этом задании я могу додумывать механику на ходу.",
  },
  {
    title:
      "Прожариваю предложенное решение",
    body:
      "Ищу дыры в логике, переусложнения, риски, сверяюсь с первоначальным заданием. В диалоге корректирую план действий и механику. Специально становлюсь критиком собственной идеи. Ищу места, где решение усложнено без нужды, где я подменила требование своим видением, а о чем просто не подумала.",
  },
  {
  ...
  {
    title:
      "Продолжаю диалог по непонятным пунктам",
    body:
      "Ресерчу бест-практис механик антифрода, ищу что можно имплементировать. Вдохновляюсь паттернами решения подобных задач в интернете. Дыры из предыдущего шага в основном закрываются здесь, но мелочи могу и оставить.",
  },
  {
  ...
  {
    title:
      "Финальная последовательная проработка умной моделью",
    body:
      "Документ ТЗ с критикой переношу в IDE, новой моделью поумнее (Opus 4.8) прорабатываем детали с помощью grill-me skill. Более предметная работа. Каждая слабая точка из критики разбирается отдельно, пока не останется мест, куда можно ткнуть пальцем и спросить \"а как это будет работать\".",
  },
  {
  ...
  {
    title: "Распределяю агентные роли",
    body:
