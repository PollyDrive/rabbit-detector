      ...
      <div className={styles.columns}>
        ...
        <div>
          ...
          <ul className={styles.assumptionList}>
            ...
            <li><strong>Диапазон</strong> на дашборде — не число кроликов, а число зон с активностью: низ — зоны с одновременными сильными сигналами, верх — все зоны с любой активностью за час.</li>
            <li><strong>Точка</strong> — нижняя граница диапазона (самая надёжная оценка одновременно занятых зон).</li>
            <li><strong>Уверенность, %</strong> — отношение точки к верхней границе диапазона (низ / верх).</li>
          </ul>
        </div>
      </div>
